<?php use App\Csrf; ?>
<p class="text-body-secondary small">Créez votre compte administrateur et votre paroisse. La connexion se fait sans mot de passe, par un lien envoyé à votre adresse email. Les autres membres seront ensuite ajoutés par invitation.</p>
